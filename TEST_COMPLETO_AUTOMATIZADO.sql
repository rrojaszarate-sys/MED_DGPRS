...
-- 2. Inserta datos de prueba completos
-- 3. Ejecuta pruebas de todas las funcionalidades
...
BEGIN
  ...
  DELETE FROM batch_movements WHERE
    ...
    numero_documento LIKE 'TRANS-2024-%';
  ...
  BEGIN
    ...
    IF v_user_id IS NULL THEN
      RAISE NOTICE '⚠️  No hay usuarios disponibles. Creando pruebas sin movimientos...';
    ELSE
